...
//		 $type = "TYPE_2";
         ...
         // build query 
         $query = "SELECT ".$tmpAgeRange.$tmpDuration.$tmp1."(bodymassindexzscore),2) AS Total, " .
         		...
         		FROM PATIENT, VISIT, COMORBIDITY,localid WHERE " .
         		...
         		"consenttobecontacted = '".$consenttobecontacted."' AND diabetestype_value = '".$diabetesType."'";

...
//         $centreId = "WA_PER_PMH"; 
         // build query MAX 
         $query_MAX_0_5 = "SELECT MAX( BodyScore ) AS MAX_0_5
							FROM (
							
							SELECT IF( AVG( visit.severehypoglycaemiaepisodes) IS NULL , 0.00, visit.severehypoglycaemiaepisodes ) AS BodyScore
							FROM visit
							JOIN patient ON visit.localid_id = patient.localid_id
	      ...
	      $query_MAX_5_10 = "SELECT MAX( BodyScore ) AS MAX_5_10
							FROM (
	      ...
	      $query_MAX_10_15 = "SELECT MAX( BodyScore ) AS MAX_10_15
							FROM (
	      ...
	      $query_MAX_15_20 = "SELECT MAX( BodyScore ) AS MAX_15_20
							FROM (
	      ...
	      $query_MAX_20_ = "SELECT MAX( BodyScore ) AS MAX_20_
							FROM (
	     ...
	     // build query MIN 
         $query_MIN_0_5 = "SELECT MIN( BodyScore ) AS MIN_0_5
							FROM (
	      ...
	      $query_MIN_5_10 = "SELECT MIN( BodyScore ) AS MIN_5_10
							FROM (
	      ...
	      $query_MIN_10_15 = "SELECT MIN( BodyScore ) AS MIN_10_15
							FROM (
	      ...
	      $query_MIN_15_20 = "SELECT MIN( BodyScore ) AS MIN_15_20
							FROM (
	      ...
	      $query_MIN_20_ = "SELECT MIN( BodyScore ) AS MIN_20_
							FROM (
		 ...
		 // build query MY 
         $query_MY_0_5 = "SELECT IF( AVG( visit.severehypoglycaemiaepisodes ) IS NULL , 0.00, visit.severehypoglycaemiaepisodes ) AS MY_0_5
							FROM visit
							JOIN patient ON visit.localid_id = patient.localid_id
							JOIN localid ON patient.localid_id = localid.id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=0
							AND TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) <5
							AND localid.centre ='".$centreId."'";	
         $query_MY_5_10 = "SELECT IF( AVG( visit.severehypoglycaemiaepisodes ) IS NULL , 0.00, visit.severehypoglycaemiaepisodes ) AS MY_5_10
							FROM visit
							JOIN patient ON visit.localid_id = patient.localid_id
							JOIN localid ON patient.localid_id = localid.id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=5
         ...
         $query_MY_10_15 = "SELECT IF( AVG( visit.severehypoglycaemiaepisodes ) IS NULL , 0.00, visit.severehypoglycaemiaepisodes ) AS MY_10_15
							FROM visit
							JOIN patient ON visit.localid_id = patient.localid_id
							JOIN localid ON patient.localid_id = localid.id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=10
							AND TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) <15
							AND localid.centre ='".$centreId."'";	
         $query_MY_15_20 = "SELECT IF( AVG( visit.severehypoglycaemiaepisodes ) IS NULL , 0.00, visit.severehypoglycaemiaepisodes ) AS MY_15_20 
							FROM visit
							JOIN patient ON visit.localid_id = patient.localid_id
							JOIN localid ON patient.localid_id = localid.id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=15
							AND TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) <20
							AND localid.centre ='".$centreId."'";	
         $query_MY_20_ = "SELECT IF( AVG( visit.severehypoglycaemiaepisodes ) IS NULL , 0.00, visit.severehypoglycaemiaepisodes ) AS MY_20_ 
							FROM visit
							JOIN patient ON visit.localid_id = patient.localid_id
							JOIN localid ON patient.localid_id = localid.id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=20
         ...
         $result_MIN_0_5 = db_select($query_MIN_0_5);
 	     ...
 	     if(($result_MAX_0_5[0]['MAX_0_5']) > $result_MAX)
 	     {
 	     	$result_MAX = $result_MAX_0_5[0]['MAX_0_5'];
 	     }
 	     if(($result_MAX_5_10[0]['MAX_5_10']) > $result_MAX)
 	     {
 	     	$result_MAX = $result_MAX_5_10[0]['MAX_5_10'];
 	     }if($result_MAX_10_15[0]['MAX_10_15'] > $result_MAX)
 	     {
 	     	$result_MAX = $result_MAX_10_15[0]['MAX_10_15'];
 	     }if($result_MAX_15_20[0]['MAX_15_20'] > $result_MAX)
 	     {
 	     	$result_MAX = $result_MAX_15_20[0]['MAX_15_20'];
 	     }if($result_MAX_20_[0]['MAX_20_'] > $result_MAX)
 	     {
 	     	$result_MAX = $result_MAX_20_[0]['MAX_20_'];
 	     }
 	     
 	     // cal MIN
 	     $result_MIN = 0.0;
 	     if($result_MIN_0_5[0]['MIN_0_5'] < $result_MIN)
 	     {
 	     	$result_MIN = $result_MIN_0_5[0]['MIN_0_5'];
 	     }
 	     if($result_MIN_5_10[0]['MIN_5_10'] < $result_MIN)
 	     {
 	     	$result_MIN = $result_MIN_5_10[0]['MIN_5_10'];
 	     } if($result_MIN_10_15[0]['MIN_10_15'] < $result_MIN)
 	     {
 	     	$result_MIN = $result_MIN_10_15[0]['MIN_10_15'];
 	     } if($result_MIN_15_20[0]['MIN_15_20'] < $result_MIN)
 	     {
 	     	$result_MIN = $result_MIN_15_20[0]['MIN_15_20'];
 	     } if($result_MIN_20_[0]['MIN_20_'] < $result_MIN)
 	     {
 	     	$result_MIN =$result_MIN_20_[0]['MIN_20_'];
 	     }

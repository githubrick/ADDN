...
//         $type = "NULL";
         ...
         $myType = "AND visit.insulinmanagement_regimen = '".$type."'";
         if($type=="NULL") 
         {
         	$myType = "AND visit.insulinmanagement_regimen IS NULL";
         }
         ...
         $query_MAX_0_5 = "SELECT MAX( PersonCnt ) AS MAX_0_5
							...
							SELECT COUNT( DISTINCT patient.localid_id ) AS PersonCnt, localid.centre
							FROM patient
							JOIN localid ON patient.localid_id = localid.id
							JOIN visit ON visit.localid_id = patient.localid_id
		 ...
		 // build query MY 
         $query_MY_0_5 = "SELECT COUNT( DISTINCT patient.localid_id ) AS MY_0_5
							FROM patient
							JOIN localid ON patient.localid_id = localid.id
							JOIN visit ON visit.localid_id = patient.localid_id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=0
							...
							".$myType."
							AND localid.centre ='".$centreId."'";	
         $query_MY_5_10 = "SELECT COUNT( DISTINCT patient.localid_id ) AS MY_5_10
							FROM patient
							JOIN localid ON patient.localid_id = localid.id
							JOIN visit ON visit.localid_id = patient.localid_id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=5
         ...
         $query_MY_10_15 = "SELECT COUNT( DISTINCT patient.localid_id ) AS MY_10_15
							FROM patient
							JOIN localid ON patient.localid_id = localid.id
							JOIN visit ON visit.localid_id = patient.localid_id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=10
							...
							".$myType."
							AND localid.centre ='".$centreId."'";	
         $query_MY_15_20 = "SELECT COUNT( DISTINCT patient.localid_id ) AS MY_15_20
							FROM patient
							JOIN localid ON patient.localid_id = localid.id
							JOIN visit ON visit.localid_id = patient.localid_id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=15
							...
							".$myType."
							AND localid.centre ='".$centreId."'";		
         $query_MY_20_ = "SELECT COUNT( DISTINCT patient.localid_id ) AS MY_20_
							FROM patient
							JOIN localid ON patient.localid_id = localid.id
							JOIN visit ON visit.localid_id = patient.localid_id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=20

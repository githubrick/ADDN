...
//         $centreId = "WA_PER_PMH"; 
         ...
         $query_MAX_0_5 = "SELECT MAX( BodyScore ) AS MAX_0_5
							...
							SELECT IF( AVG( visit.hba1c_iffc) IS NULL , 0.00, visit.hba1c_iffc ) AS BodyScore
							FROM visit
		 ...
		 // build query MY 
         $query_MY_0_5 = "SELECT IF( AVG( visit.hba1c_iffc ) IS NULL , 0.00, visit.hba1c_iffc ) AS MY_0_5
							FROM visit
							JOIN patient ON visit.localid_id = patient.localid_id
							JOIN localid ON patient.localid_id = localid.id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=0
							AND TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) <5
							AND localid.centre ='".$centreId."'";	
         $query_MY_5_10 = "SELECT IF( AVG( visit.hba1c_iffc ) IS NULL , 0.00, visit.hba1c_iffc ) AS MY_5_10
							FROM visit
							JOIN patient ON visit.localid_id = patient.localid_id
							JOIN localid ON patient.localid_id = localid.id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=5
         ...
         $query_MY_10_15 = "SELECT IF( AVG( visit.hba1c_iffc ) IS NULL , 0.00, visit.hba1c_iffc ) AS MY_10_15
							FROM visit
							JOIN patient ON visit.localid_id = patient.localid_id
							JOIN localid ON patient.localid_id = localid.id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=10
							AND TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) <15
							AND localid.centre ='".$centreId."'";	
         $query_MY_15_20 = "SELECT IF( AVG( visit.hba1c_iffc ) IS NULL , 0.00, visit.hba1c_iffc ) AS MY_15_20 
							FROM visit
							JOIN patient ON visit.localid_id = patient.localid_id
							JOIN localid ON patient.localid_id = localid.id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=15
							AND TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) <20
							AND localid.centre ='".$centreId."'";	
         $query_MY_20_ = "SELECT IF( AVG( visit.hba1c_iffc ) IS NULL , 0.00, visit.hba1c_iffc ) AS MY_20_ 
							FROM visit
							JOIN patient ON visit.localid_id = patient.localid_id
							JOIN localid ON patient.localid_id = localid.id
							WHERE TIMESTAMPDIFF( YEAR, patient.dateofbirth, NOW( ) ) >=20
